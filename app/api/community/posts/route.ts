...
특히 여행자보험은 꼭 가입하시길 추천드려요! 크루즈닷에서 가입하시면 편리하게 처리할 수 있어요 ㅎㅎ`,
    category: 'travel-tip',
    authorName: '송이엄마',
    images: ['/크루즈정보사진/크루즈배경이미지/고화질배경이미지 (1).jpg'],
    views: 1234,
    likes: 89,
    comments: 23,
...
혹시 다녀오신 분들 조언 부탁드려요 ^^`,
    category: 'qna',
    authorName: '찡찡',
    images: ['/크루즈정보사진/크루즈배경이미지/고화질배경이미지 (2).jpg'],
    views: 856,
    likes: 45,
    comments: 18,
...
음식도 다 맛있고, 배도 편안했어요. 다음에도 또 가고 싶네요!`,
    ...
    images: [
      ...
      '/크루즈정보사진/스페인 바르셀로나/스페인바르셀로나 (1).png'
    ],
    views: 2156,
    likes: 156,
    comments: 42,
...
저는 이렇게 절약해서 다음 여행 자금 마련했어요 ㅎㅎ`,
    category: 'travel-tip',
    authorName: '바다사랑',
    images: ['/크루즈정보사진/크루즈배경이미지/크루즈배경이미지 (1).png'],
    views: 1890,
    likes: 112,
    comments: 35,
...
혹시 경험 있으신 분들 조언 부탁드려요! ^^`,
    category: 'qna',
    authorName: '여행러버',
    images: ['/크루즈정보사진/로얄 브릴리앙스호/로얄 브릴리앙스호 (1).png'],
    views: 678,
    likes: 34,
    comments: 15,
...
저녁 식사 시간에 가시면 더 좋은 자리 잡을 수 있어요 ^^`,
    category: 'travel-tip',
    authorName: '크루즈킹',
    images: ['/크루즈정보사진/로얄 브릴리앙스호/로얄 브릴리앙스호 (2).png'],
    views: 1456,
    likes: 98,
    comments: 28,
...
아이들도 너무 좋아했고, 가족 모두 만족했습니다!`,
    category: 'schedule',
    authorName: '해외여행러',
    images: ['/크루즈정보사진/크루즈배경이미지/크루즈배경이미지 (2).png'],
    views: 987,
    likes: 67,
    comments: 19,
...
특히 배 중앙 쪽 방이 정말 덜 흔들려서 좋았습니다 ^^`,
    category: 'travel-tip',
    authorName: '선상낭만',
    images: ['/크루즈정보사진/로얄 브릴리앙스호/로얄 브릴리앙스호 (3).png'],
    views: 1123,
    likes: 78,
    comments: 22,
...
물이 너무 맑고 파랗고... 사진으로는 표현이 안 될 정도예요 ㅋㅋㅋ`,
    category: 'schedule',
    authorName: '오션뷰',
    images: ['/크루즈정보사진/크루즈배경이미지/고화질배경이미지 (3).png'],
    views: 1678,
    likes: 134,
    comments: 38,
...
어떤 게 나은지 경험 있으신 분들 알려주세요 ^^`,
    category: 'qna',
    authorName: '크루즈매니아',
    images: ['/크루즈정보사진/로얄 브릴리앙스호/로얄 브릴리앙스호 (4).png'],
    views: 756,
    likes: 42,
    comments: 16,
...
발코니는 다음에 가실 때 고려해보시면 좋을 것 같아요 ㅎㅎ`,
    category: 'travel-tip',
    authorName: '여행의신',
    images: ['/크루즈정보사진/로얄 브릴리앙스호/로얄 브릴리앙스호 (5).png'],
    views: 2034,
    likes: 145,
    comments: 41,
...
부모님들도 편하게 쉬실 수 있어서 만족하셨어요!`,
    category: 'schedule',
    authorName: '바다의왕자',
    images: ['/크루즈정보사진/크루즈배경이미지/크루즈배경이미지 (4).png'],
    views: 1890,
    likes: 123,
    comments: 33,
...
일부 레스토랑은 정장 필수예요 ㅎㅎ`,
    category: 'travel-tip',
    authorName: '선상요리사',
    images: ['/크루즈정보사진/크루즈배경이미지/크루즈배경이미지 (5).png'],
    views: 1345,
    likes: 89,
    comments: 26,
...
영상 보실 거 아니면 기본 패키지 추천드려요!`,
    category: 'travel-tip',
    authorName: '크루즈여행자',
    images: ['/크루즈정보사진/로얄 브릴리앙스호/로얄 브릴리앙스호 (6).png'],
    views: 1567,
    likes: 98,
    comments: 29,
...
사진으로는 표현 안 될 정도로 아름다워요 ㅎㅎ`,
    category: 'travel-tip',
    authorName: '해외탐험가',
    images: ['/크루즈정보사진/그리스 미코노스/그리스 미코노스 (4).jpg'],
    views: 2234,
    likes: 167,
    comments: 45,
...
export async function GET(req: Request) {
  try {
    ...
    // 크루즈닷늬우스는 이제 비회원도 조회 가능 (로그인 체크 제거)
    ...
    // DB에 게시글이 없으면 샘플 데이터 반환
    if (posts.length === 0 && !category && !search) {
      // 샘플 데이터를 사용 (전체 게시글 조회 시에만)
      const samplePosts = SAMPLE_POSTS.slice(0, limit).map(samplePost => ({
        id: samplePost.id,
      ...
      console.log('[COMMUNITY POSTS] Returning sample posts:', {
    ...
    console.log('[COMMUNITY POSTS] Returning posts:', {
      ...
      category,
      search,
      firstPost: formattedPosts[0]?.title || 'none'
    });
...
export async function POST(req: Request) {
  try {
    ...
    // 크루즈닷늬우스는 관리자만 작성 가능
    if (category === 'cruisedot-news' && !isAdmin) {
      return NextResponse.json(
        { ok: false, error: '크루즈닷늬우스는 관리자만 작성할 수 있습니다.' },
        { status: 403 }
      );
    }
