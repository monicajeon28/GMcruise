...
export default function AffiliateAgentDashboardPage() {
  ...
  const loadPhoneInquiries = async () => {
    try {
      ...
      console.error('[AgentDashboard] Failed to load phone inquiries:', error);
    }
  };
  ...
  const loadTeamMessages = async (showAll: boolean = false) => {
    try {
      ...
      if (res.ok && json?.ok) {
        ...
        console.error('[AgentDashboard] Failed to load team messages:', json.error);
      }
    } catch (error) {
      console.error('[AgentDashboard] Failed to load team messages:', error);
    }
  };
  ...
  const loadRecipients = async () => {
    ...
    try {
      ...
      console.error('[AgentDashboard] Failed to load recipients:', error);
    } finally {
  ...
  const handleDeleteMessage = async (messageId: number) => {
    ...
    try {
      ...
      console.error('[AgentDashboard] Failed to delete message:', error);
