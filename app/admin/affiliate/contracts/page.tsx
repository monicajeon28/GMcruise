  ...
  SUBSCRIPTION_AGENT: [
    {
      ...
      clauses: [
        ...
        '',
        '제4조 (계약기간 및 서비스 제공)',
        '① 본 계약에 따른 정액제 구독 서비스는 월 단위로 제공되며, 매월 결제일 기준으로 1개월씩 자동 갱신됩니다.',
        '② 무료 체험 기간: 첫 가입 시 7일 무료 체험을 제공하며, 무료 체험 종료 후 정식 구독이 시작됩니다.',
        '③ "판매원몰" 이용 권한 및 부가 서비스는 구독 기간 동안 유지되며, 구독 해지 시 이용 권한이 종료됩니다.',
        '',
        '제5조 (회사의 의무)',
        '"회사"는 다음과 같은 의무를 가진다.',
        ...
        '',
        '제7조 (DB 제공 및 면책)',
        '① 신규 DB 미지급: 본 계약은 월 10만 원 정액제 구독 계약이므로, "회사"와 "멘토"는 "고객사"에게 별도의 비용을 받고 판매하는 \'신규 DB(유료 DB)\'를 공급할 의무가 없다.',
        ...
        '기능 제한: 무료 체험 중 30% 기능, 정식 구독 중 50% 기능 사용 가능',
        '',
        '2. 교육 및 지원',
        '기초 교육: 크루즈 상품 이해, 판매 프로세스, 고객 상담 방법 등',
        '온라인 지원: 판매 활동 지원 및 문의 응대',
        '',
        '제11조 (계약의 해지 및 환불 기준)',
        '① 본 계약의 환불 규정은 「평생교육법」 및 「전자상거래 등에서의 소비자보호에 관한 법률」을 준수한다.',
        '② 정액제 구독 환불: 정액제는 월 구독형으로 결제일 기준 잔여 기간에 비례하여 환불됩니다.',
        '③ 환불 금액 산정: 환불 요청 시, 결제 금액(10만 원)에서 사용한 기간에 해당하는 금액을 차감한 잔액을 기준으로 산정합니다.',
        '무료 체험 중: 전액 환불 가능',
        '정식 구독 중: 잔여 기간에 비례하여 환불',
        '④ 단순 변심에 의한 환불 요청 시 결제일로부터 7일 이내에만 100% 환불이 가능합니다.',
        '',
        '제12조 (손해배상 및 위약벌)',
