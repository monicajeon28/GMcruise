          ...
          sections: [
            {
              ...
              items: [
                ...
                '입력 후 지니가 추천 후보 버튼을 띄우고, 대중교통/자동차/지도로 보기를 제공합니다.',
              ],
            },
            {
              title: '🎤 음성으로 입력하기',
          ...
          sections: [
            {
              ...
              items: [
                ...
                '지니가 지식 베이스를 검색해서 정확한 답변을 제공합니다.',
            ...
            },
            {
              ...
              items: [
                ...
                '"지니야 가자"와 "지니야 보여줘" 탭에서는 일반 대화가 제공되지 않습니다.',
              ],
            },
          ],
        };
