  ...
  return (
    <div className="container mx-auto px-3 md:px-6 py-4 md:py-8 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div>
        {/* 상품 헤더 */}
        <div className="bg-white rounded-2xl shadow-sm p-5 md:p-6 mb-5 md:mb-6 border border-gray-100">
          {/* 출처 배지 */}
          <div className="mb-4">
            {getSourceBadge()}
          </div>
                  ...
                  {recommendedKeywords.length > 0 && (
                    <div className="mb-3 flex flex-wrap gap-2">
                      {recommendedKeywords.map((keyword: string, index: number) => (
                        <span
                          key={index}
                          className="px-3 py-1.5 bg-gradient-to-r from-purple-500 to-purple-600 text-white rounded-md text-sm md:text-base font-semibold shadow-sm"
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3 md:gap-4 mb-5 md:mb-6 w-full">
            {/* 여행 기간 */}
            <div className="bg-white rounded-xl p-4 md:p-5 border border-gray-200 hover:border-gray-300 hover:shadow-md transition-all group w-full">
            ...
            <div className="mb-5 md:mb-6 flex flex-wrap gap-2">
              {finalDestination.map((countryCode: string, index: number) => {
                ...
                return (
                  <span
                    key={index}
                    className="px-3 py-1.5 bg-blue-500 text-white rounded-md text-sm md:text-base font-semibold hover:bg-blue-600 transition-colors shadow-sm"
                    style={{ wordBreak: 'keep-all' }}
                  >
                    {countryName}
                  </span>
          ...
          {/* 설명 */}
          <div className="mb-5 md:mb-6 bg-white rounded-xl p-5 md:p-6 border border-gray-200 shadow-sm">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900">상품 설명</h2>
            </div>
          ...
          {/* 포함/불포함 항목 */}
          <div className="mb-5 md:mb-6 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
            {/* 포함 사항 */}
            <div className="bg-white rounded-xl p-5 md:p-6 border border-gray-200 shadow-sm group relative">
              <div className="flex items-center justify-between mb-4">
              ...
              {editingField === 'included' ? (
                ...
                <div className="space-y-2.5">
                  {includedItems.map((item, index) => (
                    <div key={index} className="bg-white rounded-lg p-3 md:p-4 border border-gray-200 hover:border-emerald-300 transition-colors">
            ...
            <div className="bg-white rounded-xl p-5 md:p-6 border border-gray-200 shadow-sm group relative">
              ...
              {editingField === 'excluded' ? (
                ...
                <div className="space-y-2.5">
                  {excludedItems.map((item, index) => (
                    <div key={index} className="bg-white rounded-lg p-3 md:p-4 border border-gray-200 hover:border-rose-300 transition-colors">
                      <div className="flex items-start gap-2.5" style={{ wordBreak: 'keep-all', lineHeight: '1.6' }}>
          ...
          {enhancedItinerary && Array.isArray(enhancedItinerary) && enhancedItinerary.length > 0 && (
            <div className="mb-5 md:mb-6 bg-white rounded-xl p-5 md:p-6 border border-gray-200 shadow-sm">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">여행 일정</h2>
          ...
          <div className="mb-5 md:mb-6 bg-white rounded-xl p-5 md:p-6 border border-gray-200 shadow-sm group relative">
            ...
            {editingField === 'bookingInfo' ? (
              ...
              <div className="space-y-3 text-gray-700">
                {bookingInfo.map((item, index) => (
                  <div key={index} className="flex items-start gap-3 bg-gray-50 rounded-lg p-4 border border-gray-200" style={{ wordBreak: 'keep-all', lineHeight: '1.6' }}>
