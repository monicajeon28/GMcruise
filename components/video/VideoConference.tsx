  ...
  return (
    <div className={`fixed inset-0 z-50 flex flex-col bg-gray-900 ${isMobile ? 'mobile-optimized' : ''}`}>
        ...
        <div className={`flex items-center ${isMobile ? 'gap-1' : 'gap-3'}`}>
          ...
          <div className="flex items-center gap-2">
            <div className={`w-2 h-2 rounded-full ${
              networkQuality.quality === 'excellent' ? 'bg-green-500' :
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        {!remoteScreenSharing && (
          <div className={`flex flex-1 gap-4 ${isMobile ? 'p-2' : 'p-4'} ${
            viewMode === 'grid' 
              ? 'flex-wrap' 
            ...
            <div className={`${
              ...
              {/* 로컬 비디오 - 모바일 최적화 */}
              <div className={`relative rounded-lg bg-gray-800 overflow-hidden shadow-lg ${
                viewMode === 'grid' 
              ...
              {participants.map((participant) => {
                ...
                return (
                  <div
                    key={participant.id}
                    className={`relative rounded-lg bg-gray-800 overflow-hidden shadow-lg ${
                      viewMode === 'grid' 
                        ? `aspect-video w-full ${isMobile ? 'max-w-full' : 'max-w-md'}` 
                        : isMobile ? 'w-24 h-18' : 'w-32 h-24'
                ...
                <video
                  ...
                  className="h-full w-full rounded-lg object-cover"
                />
                    <div className={`absolute bottom-2 left-2 rounded px-2 py-1 text-sm text-white flex items-center gap-2 ${
                      isSpeaking ? 'bg-green-600/90' : 'bg-black/70'
                    }`}>
                      {isSpeaking && (
                        <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                      )}
                ...
                <div key={participant.id} className="flex items-center justify-between bg-gray-50 rounded p-3">
                  <div className="flex items-center gap-3">
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center text-white font-semibold ${
                      isSpeaking ? 'bg-green-600 ring-2 ring-green-400' : 'bg-gray-600'
                    }`}>
      ...
      <div className={`flex items-center justify-center gap-1 bg-gray-900 px-2 py-2 ${isMobile ? 'flex-wrap' : 'gap-2 px-6 py-3'}`} style={{ position: 'relative', zIndex: 10 }}>
        ...
        <div className="relative">
          <button
            ...
            className={`flex flex-col items-center gap-1 ${isMobile ? 'px-2 py-1 text-xs' : 'px-4 py-2'} rounded-lg transition-colors ${
              ...
              <div className="space-y-1 max-h-60 overflow-y-auto">
                <button
                  ...
                  className={`w-full text-left px-3 py-2 rounded hover:bg-gray-700 text-sm ${
                    !selectedAudioDevice ? 'bg-blue-600 text-white' : 'text-gray-300'
                  }`}
                >
                  시스템과 동일
                </button>
                {audioDevices.map((device) => (
                  <button
                    ...
                    className={`w-full text-left px-3 py-2 rounded hover:bg-gray-700 text-sm flex items-center gap-2 ${
                      selectedAudioDevice === device.deviceId ? 'bg-blue-600 text-white' : 'text-gray-300'
                    }`}
                  >
            ...
            <div className={`absolute ${isMobile ? 'bottom-full right-0 mb-2' : 'bottom-full left-1/2 transform -translate-x-1/2 mb-2'} bg-gray-800 rounded-lg shadow-xl p-4 ${isMobile ? 'w-72' : 'w-80'}`} style={{ zIndex: 9999 }}>
              ...
              <div className="space-y-1 max-h-60 overflow-y-auto">
                <button
                  ...
                  className={`w-full text-left px-3 py-2 rounded hover:bg-gray-700 text-sm ${
                    !selectedVideoDevice ? 'bg-blue-600 text-white' : 'text-gray-300'
                  }`}
                >
                  시스템과 동일
                </button>
                {videoDevices.map((device) => (
                  <button
                    ...
                    className={`w-full text-left px-3 py-2 rounded hover:bg-gray-700 text-sm flex items-center gap-2 ${
                      selectedVideoDevice === device.deviceId ? 'bg-blue-600 text-white' : 'text-gray-300'
                    }`}
                  >
              ...
              <div className="border-t border-gray-700 mt-3 pt-3 space-y-1">
                <button
                  ...
                  className={`w-full text-left px-3 py-2 rounded hover:bg-gray-700 text-sm flex items-center gap-2 ${
                    virtualBackground.type === 'blur' ? 'bg-blue-600 text-white' : 'text-gray-300'
                  }`}
                >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1 px-4 py-2 rounded-lg transition-colors ${
            viewMode === 'speaker' ? 'bg-blue-600 text-white hover:bg-blue-700' : 'bg-gray-700 text-white hover:bg-gray-600'
          }`}
        ...
        <div className="relative">
          <button
            ...
            className={`flex flex-col items-center gap-1 px-4 py-2 rounded-lg transition-colors relative ${
              showParticipantsList ? 'bg-blue-600 text-white hover:bg-blue-700' : 'bg-gray-700 text-white hover:bg-gray-600'
            }`}
            title="참가자"
          >
            <FiUsers size={20} />
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1 px-4 py-2 rounded-lg transition-colors ${
            showChat ? 'bg-blue-600 text-white hover:bg-blue-700' : 'bg-gray-700 text-white hover:bg-gray-600'
          }`}
          title="채팅"
        >
        ...
        <div className="relative">
          <button
            ...
            className={`flex flex-col items-center gap-1 px-4 py-2 rounded-lg transition-colors ${
              virtualBackground.type !== 'none' ? 'bg-blue-600 text-white hover:bg-blue-700' : 'bg-gray-700 text-white hover:bg-gray-600'
            }`}
            title="가상 배경"
          >
            <FiImage size={20} />
            ...
            <div className="space-y-2">
              <button
                ...
                className={`w-full text-left px-3 py-2 rounded hover:bg-gray-100 ${
                  virtualBackground.type === 'none' ? 'bg-blue-50 text-blue-600' : ''
                }`}
              >
                배경 없음
              </button>
              <button
                ...
                className={`w-full text-left px-3 py-2 rounded hover:bg-gray-100 ${
                  virtualBackground.type === 'blur' ? 'bg-blue-50 text-blue-600' : ''
                }`}
              >
                배경 블러
              </button>
